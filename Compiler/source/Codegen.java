...
public class Codegen {
    ...
    // registers
    public static final String FP = "Ra";
    public static final String SP = "Rb";
    public static final String RA = "Rc";
    public static final String V0 = "R8";
    public static final String V1 = "R9";
    public static final String A0 = "R7";
    public static final String T0 = "R1";
    public static final String T1 = "R2";
    public static final String T2 = "R3";
    public static final String T3 = "R4";
    public static final String T4 = "R5";
    public static final String T5 = "R6";
